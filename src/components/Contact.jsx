      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <AnimatedLine className="w-20 h-1 bg-emerald-500 rounded mb-8" delay={0.3} />
            <FadeUp delay={0.2}>
            ...
            <div className="space-y-6">
              {[
                ...
                >
                  <div className="bg-slate-50 w-12 h-12 rounded-lg flex items-center justify-center mr-4 shrink-0 group-hover:bg-emerald-50 transition-colors">
